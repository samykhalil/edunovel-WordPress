		...
		if ( WCS_ATT()->is_module_registered( 'manage' ) ) {
			...
			$settings_to_add = array_merge( $settings_to_add, array(
				array(
					...
					'type' => 'title',
					'desc' => WCS_ATT_Integrations::is_block_based_cart() ? __( 'Allow customers to add products to their existing subscriptions.', 'woocommerce-all-products-for-subscriptions' ) : __( 'Allow customers to add products and/or entire carts to their existing subscriptions.', 'woocommerce-all-products-for-subscriptions' ),
